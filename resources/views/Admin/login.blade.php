                        ...
                        <div class="bottom-blur-inner">
                            ...
                            <div class="width-c-50">
                                <p class="m-0 font-20 text-contant  gil-reg">All of the details you have submitted
                                    ...
                                    once we have an update for you.</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="form-x-box main-card ">
                                <div>
                                    <div class="d-flex flex-column mb-3 w-100">
                                        <label for="Username" class="gil-med font-18 text-salon-black">Email</label>
                                        <input name="email" type="text" class="login-fild gil-med font-18 px-3"
