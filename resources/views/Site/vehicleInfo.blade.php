            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <div class="car-details">
                        <div class="img rounded" style="background-image: url({{asset('asset/image/site/bg_1.jpg')}});"></div>
                                ...
                                <div class="row">
                                    <div class="col-md-7">
                                        ...
                                        <div class="review d-flex">
                                            <div class="user-img" style="background-image: url({{ asset('asset/image/site/person_1.jpg') }})">
                                            </div>
                                            <div class="desc">
                                                <h4>
                                        ...
                                        <div class="review d-flex">
                                            <div class="user-img" style="background-image: url({{ asset('asset/image/site/person_2.jpg') }})">
                                            </div>
                                            <div class="desc">
                                                <h4>
                                                    <span class="text-left">Jacob Webb</span>
                                        ...
                                        <div class="review d-flex">
                                            <div class="user-img" style="background-image: url({{ asset('asset/image/site/person_3.jpg') }})">
                                            </div>
                                            <div class="desc">
                                                <h4>
                                                    <span class="text-left">Jacob Webb</span>
